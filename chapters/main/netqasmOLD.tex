...
\section{Introduction}
\todo{Leftover sentence from intro section: The aim of this work is to propose a way to program quantum network programs and execute them on the end-nodes of a quantum network.}
...
As described in more detail in \cref{chp:background}, quantum networks consists of ...\todo{FILL IN}.
Also, we introduce \todo{check if this is not already in background chapter?} the terminology of application and program.
...
% \begin{figure}[t]
%       \centering
%       \caption{{\color{red} TODO: re-create image} Program interaction between the \ac{CNPU} and a quantum device in
...
We note that this design decision meets our Multitasking consideration(\cref{sec:design_considerations}).
...
% In~\cref{sec:evaluation} we use this SDK to evaluate some of the design decisions of \ac{NetQASM}.
