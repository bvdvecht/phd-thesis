...
\begin{figure}[t]
    ...
    \caption{
      \todo{Figure from NetQASM paper. Replace with new figure from QNodeOS supplementary?}
...
Examples include Quantum Key Distribution (QKD)~\cite{bb84, ekert1991quantum}, leader election protocols~\cite{kobayashi2014simpler, ganz2009quantum}, and Blind Quantum Computation (BQC)~\cite{Wehner2018stages}.\todo{schematic figure of BQC (including cartoon from QNE?)}
