...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/background/local_circuit.png}
    \caption{
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/background/2node_circuit.png}
    \caption{
      Example circuit of 2 nodes.
      \todo{elaborate}
    }
