...
\begin{figure}% [ht]
    ...
    \caption{\todo{check if this figure makes sense (too much detail?)} \todo{refer to this in text}
      Example application consisting of two hybrid classical-quantum programs (on Nodes 1 and 2) including
    ...
    \label{intro:fig:program_illustration}
\end{figure}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.35]{figures/intro/chapters_overview.png}
    \caption{\todo{caption}}
