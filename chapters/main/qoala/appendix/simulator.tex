...
In Figure~\ref{qoala:fig:app:simulator} a schematic overview of the most important classes and their roles is given, and in Figure~\ref{qoala:fig:app:simulator_sequence} an overview is provided of the general sequence of actions involved when simulating the execution of one or more applications on a quantum network.
...
is implemented as a single centralized entity called EntDist (Figure~\ref{qoala:fig:app:simulator}).
