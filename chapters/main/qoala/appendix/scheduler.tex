...
This section provides more details about tasks, task creation and scheduling (Section~\ref{qoala:sec:architecture}) as well as about our scheduler implementation~\ref{sec:implementation}.
