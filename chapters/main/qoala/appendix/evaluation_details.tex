...
The allowed gate set is expressed as a particular NetQASM flavor (\cite{dahlberg2022netqasm} and \cref{chp:netqasm}).
...
\hline
\textbf{Application} & \textbf{\# nodes} & \textbf{\begin{tabular}[c]{@{}l@{}}\# EPR\\ pairs per\\ instance\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}Max\\ \# qubits\\ per node\end{tabular}} & \textbf{\# Instances} & \textbf{\begin{tabular}[c]{@{}l@{}}Simulation\\ duration (s)\end{tabular}} \\ \hline
...
\begin{figure*}[t]
    ...
    \subfloat[\centering \label{qoala:fig:app:qkd_circuit}]{\includegraphics[width=0.6\textwidth]{figures/qoala/qkd_circuit.pdf}}
    \vspace{1cm}
    \subfloat[\centering \label{qoala:fig:app:teleport_circuit}]{\includegraphics[width=1.0\textwidth]{figures/qoala/teleport_circuit.pdf}}
    \vspace{1cm}
    \subfloat[\centering \label{qoala:fig:app:pingpong_circuit}]{\includegraphics[width=1.0\textwidth]{figures/qoala/pingpong_circuit.pdf}}
    \caption{
...
\begin{figure*}[t]
    ...
    \subfloat[\centering \label{qoala:fig:app:vbqc_circuit}]{\includegraphics[width=1.0\textwidth]{figures/qoala/vbqc_circuit.pdf}}
    \vspace{1cm}
    \subfloat[\centering \label{qoala:fig:app:ghz_circuit}]{\includegraphics[width=1.0\textwidth]{figures/qoala/ghz_circuit.pdf}}
    \vspace{1cm}
...
\paragraph{Sequential vs Interleaved execution.}
