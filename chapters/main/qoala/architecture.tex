...
% \end{tabular}
% \caption{
%     Design considerations (Section~\ref{qoala:sec:design_considerations}) and how they are addressed in the Qoala architecture (Section~\ref{qoala:sec:architecture}).
