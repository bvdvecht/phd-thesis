...
\begin{figure*}
    ...
    \centering
    \subfloat[\centering \label{qoala:fig:task_types}]{{\includegraphics[height=\figheight, keepaspectratio]{figures/qoala/task-types-table.pdf}}}%
    \hfill
    \subfloat[\centering \label{qoala:fig:task_creation_cutout}]{{\includegraphics[height=\figheight, keepaspectratio]{figures/qoala/task_creation_cutout.pdf}}}%
    \caption{
