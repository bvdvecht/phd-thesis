...
\begin{figure*}
    ...
    \centering
    \subfloat[\centering \label{fig:heatmap_teleport}]{{\includegraphics[height=\heatmapheight, keepaspectratio]{figures/qoala/heatmap_teleport.png}}}%
    \hfill
    \subfloat[\centering \label{fig:heatmap_local}]{{\includegraphics[height=\heatmapheight, keepaspectratio]{figures/qoala/heatmap_local.png}}}%
    \caption{
