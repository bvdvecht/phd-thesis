...
(network schedule, and multitasking)
...
Using an IR decouples the main compiler design from specific input and output formats, making it more flexible and scalable.
