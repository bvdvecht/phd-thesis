...
Overview: \cite{murali_full-stack_2019}.

Fully quantum circuit optimizers, mostly related to qubit mapping: \cite{li_tackling_2019, bandic_mapping_2023}.
Noise-aware optimizers: \cite{murali_noise-adaptive_2019}.
Check papers from Frederic Chong.
Mapping: QUBO
