...
\todo{mention how NetQASM/QNodeOS uses an interpreter}
\todo{schematic figure of compiler: input -> passes -> output, and of interpreter}
...
\todo{levels: hybrid value-based, hybrid memory based, split}
