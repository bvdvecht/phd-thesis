...
\begin{figure*}[htbp]
    \centering
    \subfloat[\centering \label{qnodeos:fig:subfig3}]{{\includegraphics[width=0.61\linewidth]{figures/qnodeos/supplementary/host_qnpu_latency_server.pdf}}}%
    \hfill
    \subfloat[\centering \label{qnodeos:fig:subfig4}]{{\includegraphics[width=0.35\linewidth]{figures/qnodeos/supplementary/host_qnpu_latency_client.pdf}}}%
