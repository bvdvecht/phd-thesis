...
\paragraph{NetQASM} To express quantum code blocks, we make use of \emph{\ac{NetQASM}} (see~\cite{dahlberg_2022_netqasm} and \cref{chp:netqasm}) as an instruction set for quantum network programs, which is described in detail in~\cite{dahlberg_2022_netqasm}. 
