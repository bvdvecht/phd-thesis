...
\begin{figure}[t]
      \centering
      % \includegraphics[width=0.6\textwidth]{figures/netqasm/nqasm_code_example}
      \begin{minipage}{\textwidth}
            \lstinputlisting[language=netqasm, caption={}]{chapters/main/netqasm/nqasm_code_example.nqasm}
      \end{minipage}
