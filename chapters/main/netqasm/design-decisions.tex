...
\todo{Re-create Figure 5 from netqasm paper?}
...
As described in \cref{netqasm:sec:preliminaries}, and also in \cref{netqasm:sec:design_considerations} program execution is split across the \ac{CNPU} and the \ac{QNPU}.
Since the \ac{QNPU} is assumed to have limited processing power (\cref{netqasm:sec:preliminaries}), our design lets the \ac{CNPU} do most of the classical processing.
...
Examples are given in \cref{netqasm:sec:sdk} and the Appendix.