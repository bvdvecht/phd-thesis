...
\todo{Remove parts that are already in preliminaries}
...
\todo{Remove and make sure everything is in preliminaries?}
...
\todo{merge this with first sentence of contribution?}
...
\begin{figure}[t]
    ...
    \caption{\todo{check if indeed CNPU and QNPU are meant here} A quantum network application consists of a program for each of the nodes involved in the application.
