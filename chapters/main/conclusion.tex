...
In \cref{qoala:sec:program_instantiation} we mentioned that the compiler provides advice that the nodes use in a capability negotiation and demand registration (\cref{qoala:sec:program_instantiation}).
